...
CLAIMED: Junior seat, 2026-08-26 — J-6 volume rows. Scope: `src/app/{prefs,menu,window,audio_bridge}.rb`, locale/display menu vocabulary, focused tests, `menu_tour` visual proof; feature-detected audio API, machine-local prefs only, zero sim/save/netplay state.
