...
CLAIMED: E0 boss rotation snapshot fix (T0 BLOCKER a1: `begin_action` snapshots the begun skill so started arc == resolved arc; ember_boss phase-2 repro + canary + tower4/brasa3 gates) — Gabriel seat, s134. Spark: `docs/sparkups/sparkup-v22-e0-e1-t1-20260905.md` §1.

PREVIOUS: none — **s133 closed: v22 SPEC + TICKETS cut (council-reviewed), art charter written on the owner's baseline + "A now", T0 review BANKED (64 findings → E0–E5), both spokes harvested/relaunched; the next session runs `docs/sparkups/sparkup-v22-e0-e1-t1-20260905.md`** (E0 BLOCKER fix → E1 harness truth → T1 schema 3; one ticket per session; T1's reviewer brief staged at `docs/sparkups/t1-review-brief-20260905.md`). Cycle state: `docs/CYCLE.md`. Law: `drafts/_v22-foundation-20260905.md` (L1–L20, owner words s133 verbatim in §RATIFICATION). Spec: `docs/superpowers/specs/2026-09-05-v22-one-body-cycle.md`. Restore tags unchanged: `restore/pre-mundo-vivo-20260904` (`cf9a6a6`) · `restore/post-mundo-vivo-20260905`.
