...
CLAIMED: Junior seat, 2026-08-26 — corpse-legibility flywheel candidate (s74-verified). Scope: `src/app/renderer.rb` draw_corpses only (1px dark outline per shipped C1/N2/N4 grammar + human base tone retune, display-keyed), pixel tests, determinism gates on corpse-bearing scripts; drops/sim/corpse placement untouched. Critic-ON verdicts will ride the hub (voice-dev infra gap, J-6 precedent).
