...
| Lag — the ~7% in-process long-frame tail | `drafts/_lag-t3-verdict-20260820.md` §4 + Junior's T4 probe (`drafts/_junior-pilot-walk-20260821.md` §ACHADO: over20 16.8%, draw p95 15.3 ms) | app/perf | **TRIGGER FIRED 2026-08-21** (Junior FELT it + banked numbers) → s28 diagnosed DRAW as the tail (zone_7 2.2× district, update innocent) and shipped the merged-static-runs render fix (`dd8ff40`, captures byte-identical; ticket `drafts/_wb-t5-wirein-20260821.md`). Junior's re-measure is the decisive seat — owner-paced; if his over20 doesn't drop, the row re-opens with his numbers. |
