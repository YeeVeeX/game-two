...
| Lag T4 — vsync release result | `drafts/_lag-t4-vsync-20260820.md` (`ce78bfc` env-gated, canary PASS, fresh-eyes PASS) | app/presentation (pacing) | SHIPPED behind `GAME_VSYNC_OFF`; decisive oracle = Junior's S0-J re-run, owner-paced (pt-br two-liner staged in ticket §4). |
