...
| Lag — the ~7% in-process long-frame tail | `drafts/_lag-t3-verdict-20260820.md` §4 + Junior's T4 table (over20 ~7% both runs) | app/perf | With the ceiling hypothesis dead this is the ONLY remaining lag lever — still gated on "the owners still feel lag" (their word, never nag). |
