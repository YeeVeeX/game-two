...
7. Ao terminar: suite verde, `lane_guard` OK, `git push -u origin lane/validator`, e UMA linha no
   BOARD: `RECEIPT: validator <sha> READY <resumo de 1 linha>` (+ os PATCH REQUESTS).
