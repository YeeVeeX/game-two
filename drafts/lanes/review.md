...
7. Ao terminar: suite verde, `lane_guard` OK, `git push -u origin lane/review`, e UMA linha no
   BOARD: `RECEIPT: review <sha> READY <resumo de 1 linha>` (+ os PATCH REQUESTS).
