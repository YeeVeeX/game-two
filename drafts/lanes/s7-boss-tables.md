...
owns:
  ...
  - drafts/lanes/s7-boss-tables.md
never:
  - src/game/world.rb
...
7. Ao terminar: suite verde, `lane_guard` OK, `git push -u origin lane/s7-boss-tables`, e UMA linha no
   BOARD: `RECEIPT: s7-boss-tables <sha> READY <resumo de 1 linha>` (+ os PATCH REQUESTS).
